            ...
            <div class="row">
                ...
                <div class="col-6">
                    <h3 class="srtKTSU">Hasil Pencarian :
                        <button type="button" class="btn btn-outline-dark" disabled>Toko</button>
                        <button type="button" class="btn btn-outline-dark" disabled>Toko Busana Aqila</button>
                    </h3>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <center>
                                    <img src='assets/images/iklan1.jpg' id="imgSKT" class="img-thumbnail btn btn-light"
