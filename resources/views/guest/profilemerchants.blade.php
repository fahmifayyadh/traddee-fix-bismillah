...
<html lang="en">
<head>
  <title>TRADEE.COM | MERCHANTS | {{ $ukm->merchant_name }}</title>
  <meta charset="utf-8">
                  ...
                  <div id="daftar" class="tab-pane active"><br>
                                <table class="table table-bordered ">
                                  ...
                                  <tr>
                                      ...
                                      <td id="thProfileMerch">images.png</td>
                                      <td id="thProfileMerch">Ini baju tidur</td>
                                      <td id="thProfileMerch">Tampil</td>
                                      <td><button type="button" class="btn" data-toggle="modal" data-target="#editProduct" id="thProfileMerch" >Edit</button>|<button type="button" class="btn" id="thProfileMerch">Hapus</button></td>
                                  </tr>
                  ...
                  <div id="editprofile" class="container tab-pane fade"><br>
                    ...
                    <form action="#">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="namaToko" placeholder="TOKO BUSANA AQILA">
                      </div>
                      <div class="form-group">
                        <label>Foto Profile : </label></br>
                        <img src='assets/images/user.png' width="100px" height="100px"> <input type="file" class="form-control-file border mr-2" id="fotoProfile">
                      </div>
                      <div class="form-group">
                        <label for="pwd">Banner Profile : </label></br>
                        <img src='assets/images/aqilabg.jpg' width="150px" height="100px"> <input type="file" class="form-control-file border mt-2" id="bannerProfile">
                      </div>
                  ...
                  <div id="editinformasi" class="container tab-pane fade"><br>
                    ...
                    <form action="#">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="namaToko" placeholder="Aqila nur amalia">
                        </div>
                        <div class="form-group">
                            <label for="email">Alamat Toko : </label></br>
                          <input type="text" class="form-control" id="namaToko" placeholder="Provinsi"></br>
                          <input type="text" class="form-control" id="namaToko" placeholder="Kabupaten / Kota"></br>
                          <input type="text" class="form-control" id="namaToko" placeholder="Kecamatan"></br>
                          <input type="text" class="form-control" id="namaToko" placeholder="Kelurahan / Desa"></br>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="namaToko" placeholder="2323-2323-2323-222">
                        </div>
